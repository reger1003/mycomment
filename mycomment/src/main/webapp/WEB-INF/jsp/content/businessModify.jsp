					...
					<table class="tab1" width="100%">
						<tbody>
							<tr>
								...
								<td width="30%">
									<input id="subtitle" name="subtitle" value="${modifyObj.subtitle}" class="allInput" style="width:100%;" type="text"/>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td width="30%">
									<input id="price" name="price"  value="${modifyObj.price}" class="allInput" style="width:100%;" type="text"/>
								</td>
								<td align="right" width="10%">距离(单位：米)<font color="red">*</font>：</td>
								<td width="30%">
									<input id="distance" name="distance" value="${modifyObj.distance}" class="allInput" style="width:100%;" type="text"/>
								</td>
							</tr>
							<tr>
								<td align="right">描述<font color="red">*</font>：</td>
								<td width="30%" colspan="3">
									<textarea  id="descsort" name="descsort" rows="5" style="width:100%;">${modifyObj.descsort}</textarea>
								</td>
							</tr>
						</tbody>
					</table>
